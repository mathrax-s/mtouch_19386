...
enum mtouch_button_state
{
    ...
    const mtouch_button_t mtouch_button_init[10u] =
    {
...
static mtouch_button_t mtouch_button[10u];
...
void MTOUCH_Button_InitializeAll(void)
{
    ...
    for (button = 0; button < 10u; button++)
    {
...
static _Bool Button_Check_AKS_Block(mtouch_button_t* button)
{
    ...
    for(check_button = &mtouch_button[0];check_button <= &mtouch_button[10u -1];check_button++)
    {
...
# 852 "mcc_generated_files/mtouch/mtouch_button.c"
static void Button_DefaultCallback(enum mtouch_button_names button) { }
