...
# 235 "mcc_generated_files/mtouch/../pin_manager.h"
...
# 89 "mcc_generated_files/mtouch/mtouch_sensor.h"
...
# 109 "mcc_generated_files/mtouch/mtouch_button.h"
...
static mtouch_slider_t mtouch_slider[2u] = {
...
# 202 "mcc_generated_files/mtouch/mtouch_slider.c"
static uint16_t divide(uint16_t numerator, uint16_t denominator, uint8_t exponent)
{
    uint16_t result = 0u;
...
# 262 "mcc_generated_files/mtouch/mtouch_slider.c"
static int16_t get_difference(mtouch_slider_t* slider, uint16_t previous_position, uint16_t current_position)
{
    int16_t diff;
...
# 352 "mcc_generated_files/mtouch/mtouch_slider.c"
static uint16_t moving_average_filter(mtouch_slider_t* slider, uint16_t current_position)
{
...
# 552 "mcc_generated_files/mtouch/mtouch_slider.c"
    if (size < 16u)
    {
...
void MTOUCH_Slider_InitializeAll(void)
{
    ...
    for (slider = 0u; slider < 2u; slider++)
    {
...
_Bool MTOUCH_Slider_Reburst_Service(void)
{
    ...
    for(sliderName = 0;sliderName < 2u;sliderName++)
    {
