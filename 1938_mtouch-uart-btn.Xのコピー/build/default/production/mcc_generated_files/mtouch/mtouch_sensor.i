...
static mtouch_sensor_t mtouch_sensor[10u] ={
    ...
    {Sensor_AN3,MTOUCH_CVD_ScanA_6,MTOUCH_CVD_ScanB_6, 32u,0,0,0,0},
    {Sensor_AN2,MTOUCH_CVD_ScanA_7,MTOUCH_CVD_ScanB_7, 32u,0,0,0,0},
    {Sensor_AN1,MTOUCH_CVD_ScanA_8,MTOUCH_CVD_ScanB_8, 32u,0,0,0,0},
    {Sensor_AN0,MTOUCH_CVD_ScanA_9,MTOUCH_CVD_ScanB_9, 32u,0,0,0,0},
};
...
void MTOUCH_Sensor_InitializeAll(void)
{
    ...
    for (sensor = 0; sensor < 10u; sensor++)
    {
...
# 387 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
# 483 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
    if(sensor < 10u)
...
# 518 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 555 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
    mtouch_sensor_t* sensor;
    for(sensor = &mtouch_sensor[0];sensor<= &mtouch_sensor[10u -1];sensor++)
    {
