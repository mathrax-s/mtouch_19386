...
static mtouch_sensor_t mtouch_sensor[3u] ={
    {Sensor_AN13,MTOUCH_CVD_ScanA_0,MTOUCH_CVD_ScanB_0, 32u,0,0,0,0},
    {Sensor_AN1,MTOUCH_CVD_ScanA_1,MTOUCH_CVD_ScanB_1, 32u,0,0,0,0},
    {Sensor_AN0,MTOUCH_CVD_ScanA_2,MTOUCH_CVD_ScanB_2, 32u,0,0,0,0},
};
...
# 188 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    enum mtouch_sensor_names sensor;
    for (sensor = 0; sensor < 3u; sensor++)
...
# 216 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_isAnySensorActive(void)
{
    enum mtouch_sensor_names sensor;
...
# 380 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
# 476 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
    if(sensor < 3u)
...
# 511 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 548 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
