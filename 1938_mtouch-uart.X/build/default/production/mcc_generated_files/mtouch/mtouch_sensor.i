...
# 1 "mcc_generated_files/mtouch/mtouch_button.h" 1
# 46 "mcc_generated_files/mtouch/mtouch_slider.h" 2
...
# 44 "mcc_generated_files/mtouch/../mtouch/mtouch.h" 2
# 55 "mcc_generated_files/mtouch/../mtouch/mtouch.h"
...
# 39 "mcc_generated_files/mtouch/mtouch_sensor_scan.h" 2
    ...
    void MTOUCH_CVD_ScanA_10(void);
    void MTOUCH_CVD_ScanB_10(void);
...
static mtouch_sensor_t mtouch_sensor[11u] ={
    {Sensor_AN12,MTOUCH_CVD_ScanA_0,MTOUCH_CVD_ScanB_0, 32u,0,0,0,0},
    {Sensor_AN10,MTOUCH_CVD_ScanA_1,MTOUCH_CVD_ScanB_1, 32u,0,0,0,0},
    {Sensor_AN8,MTOUCH_CVD_ScanA_2,MTOUCH_CVD_ScanB_2, 32u,0,0,0,0},
    {Sensor_AN9,MTOUCH_CVD_ScanA_3,MTOUCH_CVD_ScanB_3, 32u,0,0,0,0},
    {Sensor_AN11,MTOUCH_CVD_ScanA_4,MTOUCH_CVD_ScanB_4, 32u,0,0,0,0},
    {Sensor_AN13,MTOUCH_CVD_ScanA_5,MTOUCH_CVD_ScanB_5, 32u,0,0,0,0},
    {Sensor_AN4,MTOUCH_CVD_ScanA_6,MTOUCH_CVD_ScanB_6, 32u,0,0,0,0},
    {Sensor_AN3,MTOUCH_CVD_ScanA_7,MTOUCH_CVD_ScanB_7, 32u,0,0,0,0},
    {Sensor_AN2,MTOUCH_CVD_ScanA_8,MTOUCH_CVD_ScanB_8, 32u,0,0,0,0},
    {Sensor_AN1,MTOUCH_CVD_ScanA_9,MTOUCH_CVD_ScanB_9, 32u,0,0,0,0},
    {Sensor_AN0,MTOUCH_CVD_ScanA_10,MTOUCH_CVD_ScanB_10, 32u,0,0,0,0},
};
...
void MTOUCH_Sensor_InitializeAll(void)
{
    ...
    for (sensor = 0; sensor < 11u; sensor++)
    {
...
# 196 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    enum mtouch_sensor_names sensor;
    for (sensor = 0; sensor < 11u; sensor++)
...
# 224 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_isAnySensorActive(void)
{
    enum mtouch_sensor_names sensor;
...
# 388 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_Acq_ExecuteScan(void)
{
...
# 484 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Disable(enum mtouch_sensor_names sensor)
{
    if(sensor < 11u)
...
# 519 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 556 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
    mtouch_sensor_t* sensor;
    for(sensor = &mtouch_sensor[0];sensor<= &mtouch_sensor[11u -1];sensor++)
    {
